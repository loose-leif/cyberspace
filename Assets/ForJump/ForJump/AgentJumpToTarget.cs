...
{   
    ...
    void MakeJumpPath()
    {
        ...
        var tempMid1 = Vector3.Lerp(JumpStartPoint, JumpEndPoint, 0.25f);
        tempMid1.y = tempMid1.y + NavMeshAgent.height + AddToJumpHeight;

        Path.Add(tempMid1);

        var tempMid2 = Vector3.Lerp(JumpStartPoint, JumpEndPoint, 0.75f);
        tempMid2.y = tempMid2.y + NavMeshAgent.height + AddToJumpHeight;
